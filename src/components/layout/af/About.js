            ...
            <div className="container" id="aboutMe">
                <div className="row">
                    <div className="col-12 text-center my-5">
                        ...
                        <p style={{fontWeight:'370', fontSize:'17px', marginBottom:'20px', lineHeight:'1.4'}}>
                        ...
                        <p style={{fontWeight:'400', fontSize:'20px'}}>O objetivo deste site é facilitar a visualização dos projetos que estou criando e/ou usando para estudo.</p>
                    </div>
                </div>
                <div style={{flex:'0 0 100%', width:'99%', marginTop:'2rem', boxSizing:'border-box'}}>
            <hr></hr>
        </div>
            </div>
    )
